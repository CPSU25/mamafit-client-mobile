...
export default function VoucherCard({ voucher, savedAmount }: VoucherCardProps) {
  return (
    <View className='flex-row'>
      ...
      <View className='flex-1 p-2 border border-y-border border-r-border border-l-transparent flex-row items-center rounded-r-xl'>
        <Text className='text-xs flex-1'>{voucher.code}</Text>
        <Text className='font-inter-semibold text-emerald-500'>
