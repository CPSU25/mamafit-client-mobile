  ...
  bank: ({ size, color = 'PRIMARY' }: SvgIconProps) => (
    <Svg width={size} height={size} viewBox='0 0 24 24' fill='none'>
      ...
      <G id='SVGRepo_iconCarrier'>
        ...
        ></Path>
        <Path opacity='0.6' d='M8 11H4V18H8V11Z' fill='#f59e0b'></Path>
        <Path opacity='0.4' d='M12 11H8V18H12V11Z' fill='#f59e0b'></Path>
        <Path opacity='0.6' d='M16 11H12V18H16V11Z' fill='#f59e0b'></Path>
        <Path opacity='0.4' d='M20 11H16V18H20V11Z' fill='#f59e0b'></Path>
        <Path
