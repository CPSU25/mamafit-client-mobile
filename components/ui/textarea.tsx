...
function Textarea({
  ...
  return (
    <TextInput
      className={cn(
        'text-foreground min-h-[80px] max-h-[110px] border-input dark:bg-input/30 flex w-full flex-row rounded-xl border bg-transparent px-3 py-2 text-base shadow-sm shadow-black/5 md:text-sm',
        Platform.select({
