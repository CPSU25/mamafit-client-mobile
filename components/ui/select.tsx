...
function SelectTrigger({
  ...
  return (
    ...
    >
      {children}
      <Feather name='chevron-down' size={16} color={isDarkColorScheme ? 'white' : 'black'} />
    </SelectPrimitive.Trigger>
  )
}
...
function SelectScrollUpButton({ className, ...props }: SelectPrimitive.ScrollUpButtonProps) {
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <Feather name='chevron-up' size={16} color={isDarkColorScheme ? 'white' : 'black'} />
    </SelectPrimitive.ScrollUpButton>
  )
}
    ...
    >
      <View className='absolute left-2 native:left-3.5 flex h-3.5 native:pt-px w-3.5 items-center justify-center'>
        <SelectPrimitive.ItemIndicator>
          <Feather name='check' size={16} color={isDarkColorScheme ? 'white' : 'black'} />
        </SelectPrimitive.ItemIndicator>
      </View>
