...
export default function DiaryHistoryDetailScreen() {
  ...
  const { methods, initializeMeasurementsForm } = useEditMeasurementDetail()
        ...
        <FormProvider {...methods}>
          ...
          <View className='flex flex-col gap-4 p-4'>
            ...
            {mainData.map((category, categoryIndex) => (
              <Dialog key={category.title}>
                <DialogTrigger asChild>
                  <TouchableOpacity>
                    <Animated.View entering={FadeInDown.delay(200 + categoryIndex * 100)} className='rounded-2xl'>
                      <Card className='p-2'>
